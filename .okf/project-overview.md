...
- Shows `Pi needs attention` IDE notifications when Pi finishes work and the Pi tab is not selected.
- Dismisses active Pi attention notifications when the Pi tab becomes selected.
